...
enum WatchMessagingPayloadCodec {
  ...
  static func encodeExecApprovalPromptPayload(
    _ message: OpenClawWatchExecApprovalPromptMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
  ...
  static func encodeExecApprovalResolvedPayload(
    _ message: OpenClawWatchExecApprovalResolvedMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
  ...
  static func encodeExecApprovalExpiredPayload(
    _ message: OpenClawWatchExecApprovalExpiredMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
  ...
  static func encodeExecApprovalSnapshotPayload(
    _ message: OpenClawWatchExecApprovalSnapshotMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
  ...
  static func encodeAppSnapshotPayload(
    _ message: OpenClawWatchAppSnapshotMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
  ...
  static func parseExecApprovalResolvePayload(
    ...
    guard (payload["type"] as? String) == OpenClawWatchPayloadType.execApprovalResolve.rawValue
    else {
      return nil
    }
  ...
  static func parseExecApprovalSnapshotRequestPayload(
    ...
    guard
      (payload["type"] as? String) == OpenClawWatchPayloadType.execApprovalSnapshotRequest.rawValue
    else {
      return nil
    }
  ...
  static func parseAppSnapshotRequestPayload(
    ...
    guard (payload["type"] as? String) == OpenClawWatchPayloadType.appSnapshotRequest.rawValue
    else {
      return nil
    }
    let requestId = self.nonEmpty(payload["requestId"] as? String) ?? UUID().uuidString
