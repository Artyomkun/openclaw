...
enum TalkVoiceModeDescriptorBuilder {
  static func build(
    ...
    let title =
      if isRealtime, normalizedProvider == "openai", trimmedModel == "gpt-realtime-2" {
        "GPT Realtime 2.0"
...
enum TalkModeGatewayConfigParser {
  ...
  private static func resolvedExecutionMode(_ realtime: [String: AnyCodable]?)
    -> TalkModeExecutionMode
  {
