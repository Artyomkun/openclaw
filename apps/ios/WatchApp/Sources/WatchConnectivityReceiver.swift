...
final class WatchConnectivityReceiver: NSObject, @unchecked Sendable {
  ...
  private func sendPayload(_ payload: [String: Any], session: WCSession) async
  ...
  private static func sendMessage(_ payload: [String: Any], through session: WCSession) async throws
  {
    try await withCheckedThrowingContinuation(isolation: nil) {
      (continuation: MessageSendContinuation) in
      session.sendMessage(
        payload,
  ...
  private static func parseNotificationPayload(_ payload: [String: Any]) -> WatchNotifyMessage? {
    ...
    let details = (payload["details"] as? String)?
      .trimmingCharacters(in: .whitespacesAndNewlines)
    let expiresAtMs =
      (payload["expiresAtMs"] as? Int) ?? (payload["expiresAtMs"] as? NSNumber)?.intValue
  ...
  private static func parseExecApprovalItem(_ value: Any?) -> WatchExecApprovalItem? {
    ...
    let expiresAtMs =
      (payload["expiresAtMs"] as? Int) ?? (payload["expiresAtMs"] as? NSNumber)?.intValue
    let riskRaw =
      (payload["risk"] as? String)?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
  ...
  private static func parseExecApprovalPromptPayload(
  ...
  ) -> WatchExecApprovalPromptMessage? {
    guard let type = payload["type"] as? String,
    ...
    let sentAtMs = (payload["sentAtMs"] as? Int) ?? (payload["sentAtMs"] as? NSNumber)?.intValue
    let deliveryId = (payload["deliveryId"] as? String)?.trimmingCharacters(
  ...
  private static func parseExecApprovalResolvedPayload(
    _ payload: [String: Any]
  ) -> WatchExecApprovalResolvedMessage? {
    guard let type = payload["type"] as? String,
    ...
    let approvalId =
      (payload["approvalId"] as? String)?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
    guard !approvalId.isEmpty else { return nil }
    let decision = Self.parseExecApprovalDecision(payload["decision"])
    let resolvedAtMs =
      (payload["resolvedAtMs"] as? Int)
  ...
  private static func parseExecApprovalExpiredPayload(
    _ payload: [String: Any]
  ) -> WatchExecApprovalExpiredMessage? {
    guard let type = payload["type"] as? String,
    ...
    let approvalId =
      (payload["approvalId"] as? String)?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
    let rawReason =
      (payload["reason"] as? String)?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
    ...
    let expiredAtMs =
      (payload["expiredAtMs"] as? Int) ?? (payload["expiredAtMs"] as? NSNumber)?.intValue
  ...
  private static func parseExecApprovalSnapshotPayload(
    _ payload: [String: Any]
  ) -> WatchExecApprovalSnapshotMessage? {
    guard let type = payload["type"] as? String,
    ...
    let sentAtMs = (payload["sentAtMs"] as? Int) ?? (payload["sentAtMs"] as? NSNumber)?.intValue
    let snapshotId = (payload["snapshotId"] as? String)?.trimmingCharacters(
      in: .whitespacesAndNewlines)
  ...
  private static func parseAppSnapshotPayload(_ payload: [String: Any]) -> WatchAppSnapshotMessage?
  {
    ...
    let gatewayStatusText =
      (payload["gatewayStatusText"] as? String)?
      .trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
    let agentName =
    ...
    let gatewayStableID = (payload["gatewayStableID"] as? String)?
      .trimmingCharacters(in: .whitespacesAndNewlines)
    let talkStatusText =
      (payload["talkStatusText"] as? String)?
      .trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
    let pendingApprovalCount =
      (payload["pendingApprovalCount"] as? Int)
  ...
  private static func parseChatItem(_ item: Any) -> WatchChatItem? {
    ...
    let trimmedRole =
      (dict["role"] as? String)?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
  ...
  private static func encodeAppSnapshotRequestPayload(
    _ request: WatchAppSnapshotRequestMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
  ...
  private static func encodeAppCommandPayload(_ message: WatchAppCommandMessage) -> [String: Any] {
    ...
    if let gatewayStableID = message.gatewayStableID?.trimmingCharacters(
      in: .whitespacesAndNewlines),
  ...
  private static func encodeSnapshotRequestPayload(
    _ request: WatchExecApprovalSnapshotRequestMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
  ...
  private static func encodeExecApprovalResolvePayload(
    _ message: WatchExecApprovalResolveMessage
  ) -> [String: Any] {
    var payload: [String: Any] = [
