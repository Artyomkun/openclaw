...
actor CameraCaptureService {
  ...
  func clip(
    ...
    deviceId: String?,
    outPath: String?
  ) async throws -> (path: String, durationMs: Int, hasAudio: Bool) {
    let facing = facing ?? .front
  ...
  nonisolated static func normalizeSnap(maxWidth: Int?, quality: Double?) -> (
  ...
  private nonisolated static func mapMovieSetupError(_ setupError: CameraSessionConfigurationError)
    -> CameraError
  {
