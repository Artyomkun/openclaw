...
enum CronPayload: Codable, Equatable {
  ...
  enum CodingKeys: String, CodingKey {
    case kind, text, message, thinking, timeoutSeconds, deliver, channel, provider, to,
      bestEffortDeliver
  }
  ...
  func encode(to encoder: Encoder) throws {
    ...
    case .agentTurn(
      let message, let thinking, let timeoutSeconds, let deliver, let channel, let to,
      let bestEffortDeliver):
