...
enum DeviceModelCatalog {
  ...
  static func presentation(deviceFamily: String?, modelIdentifier: String?) -> DevicePresentation? {
    ...
    let symbol = self.symbol(
      deviceFamily: family, modelIdentifier: model, friendlyName: friendlyName)
  ...
  private static func symbolFor(modelIdentifier rawModelIdentifier: String, friendlyName: String?)
    -> String?
  {
