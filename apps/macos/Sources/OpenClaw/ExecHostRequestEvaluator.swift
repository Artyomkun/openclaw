...
enum ExecHostRequestEvaluator {
  static func validateRequest(_ request: ExecHostRequest) -> Result<
    ExecHostValidatedRequest, ExecHostError
  > {
  ...
  static func evaluate(
    ...
    let requiresPrompt =
      ExecApprovalHelpers.requiresAsk(
        ask: context.ask,
