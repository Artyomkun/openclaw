...
enum HostEnvSanitizer {
  /// Generated from src/infra/host-env-security-policy.json via scripts/generate-host-env-security-policy-swift.ts.
  ...
  private static func filterOverridesForShellWrapper(_ overrides: [String: String]?) -> [String:
    String]?
  {
  ...
  static func inspectOverrides(
    ...
    blockPathOverrides: Bool = true
  ) -> HostEnvOverrideDiagnostics {
