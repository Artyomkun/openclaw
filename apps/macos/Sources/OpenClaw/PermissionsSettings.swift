      ...
      VStack(alignment: .leading, spacing: 20) {
        ...
        SettingsCardGroup("Setup") {
          SettingsCardRow(
            ...
            subtitle:
              "Use this if macOS prompts were skipped or permissions need a fresh walkthrough.",
            showsDivider: false
          ) {
...
private struct LocationAccessSettings: View {
  ...
  @AppStorage(locationModeKey) private var locationModeRaw: String = OpenClawLocationMode.off
    .rawValue
