...
struct TalkOverlayView: View {
  ...
  private static let defaultSeamColor = Color(
    red: 79 / 255.0, green: 122 / 255.0, blue: 154 / 255.0)
  ...
  var body: some View {
    ZStack {
      ForEach(0..<3, id: \.self) { idx in
        ...
        let alpha =
          self.phase == .speaking ? 0.72 : self.phase == .listening ? 0.58 + self.level * 0.28 : 0.4
        Circle()
