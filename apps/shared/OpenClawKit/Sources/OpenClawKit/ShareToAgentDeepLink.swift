...
public enum ShareToAgentDeepLink {
  public static func buildURL(from payload: SharedContentPayload, instruction: String? = nil)
    -> URL?
  {
  ...
  public static func buildMessage(from payload: SharedContentPayload, instruction: String? = nil)
    -> String
  {
    ...
    let resolvedInstruction =
      self.clean(instruction) ?? self.clean(ShareToAgentSettings.loadDefaultInstruction())
