...
public struct AnyCodable: Codable, @unchecked Sendable, Hashable {
  ...
  public static func == (lhs: AnyCodable, rhs: AnyCodable) -> Bool {
    ...
    case (let l as Bool, let r as Bool): l == r
    case (let l as Int, let r as Int): l == r
    case (let l as Double, let r as Double): l == r
    case (let l as String, let r as String): l == r
    case (_ as NSNull, _ as NSNull): true
    case (let l as [String: AnyCodable], let r as [String: AnyCodable]): l == r
    case (let l as [AnyCodable], let r as [AnyCodable]): l == r
    default:
      false
    }
  }
