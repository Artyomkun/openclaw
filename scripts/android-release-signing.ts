...
function usage() {
  ...
  scripts/android-release-signing.ts --mode plan
  scripts/android-release-signing.ts --mode check
  scripts/android-release-signing.ts --mode sync-pull
  scripts/android-release-signing.ts --mode sync-push --keystore PATH --properties PATH
...
function writeMaterializedProperties(materializedDir, sourceProperties) {
  ...
  const content = [
    "# Generated by scripts/android-release-signing.ts.",
