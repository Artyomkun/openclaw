...
import { BUNDLED_PLUGIN_PATH_PREFIX } from "./lib/bundled-plugin-paths.ts";
import {
  collectModuleReferencesFromSource,
  normalizeRepoPath,
  resolveRepoSpecifier,
  writeLine,
} from "./lib/guard-inventory-utils.ts";
import { mapWithConcurrency } from "./lib/source-file-scan-cache.ts";
import {
