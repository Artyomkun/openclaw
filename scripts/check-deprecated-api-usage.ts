...
import { collectDeprecatedInternalConfigApiViolations } from "./lib/deprecated-config-api-guard.ts";
import { buildDeprecatedPluginSdkModuleSpecifiers } from "./lib/deprecated-plugin-sdk-usage.ts";

const repoRoot = process.cwd();

const sourceExtensions = new Set([".ts", ".tsx", ".js", ".ts", ".ts"]);
