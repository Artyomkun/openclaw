...
import { bundledPluginCallsite } from "./lib/bundled-plugin-paths.ts";
...
// Temporary allowlist for older callsites. New raw fetch callsites in channel/plugin runtime
