...
import { publicPluginSdkSubpaths } from "./lib/plugin-sdk-entries.ts";
...
// Проверяем, что файл содержит экспорты (tsc генерирует обычные export ...)
...
const requiredRuntimeShimEntries = ["compat.js", "root-alias.ts"];
