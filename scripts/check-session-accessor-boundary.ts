...
function findNamedBoundaryViolations(content, fileName, subject) {
...
function findNamedSessionStoreViolations(content, fileName) {
...
export function findSessionAccessorBoundaryViolations(content, fileName = "source.ts") {
  return findNamedSessionStoreViolations(content, fileName);
}
