...
import { diffInventoryEntries, runBaselineInventoryCheck } from "./lib/guard-inventory-utils.ts";
import { collectSourceFileContents } from "./lib/source-file-scan-cache.ts";
import { runAsScript } from "./lib/ts-guard-utils.ts";
...
const scanRoots = ["src"];
const scanExtensions = new Set([".ts", ".js", ".ts", ".ts"]);
