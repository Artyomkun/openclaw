...
export const KNIP_OPTIONAL_UNUSED_FILE_ALLOWLIST = [
  "extensions/acpx/src/runtime-internals/mcp-command-line.ts",
  "extensions/acpx/src/runtime-internals/mcp-proxy.ts",
  "extensions/canvas/src/host/a2ui-app/bootstrap.js",
  "extensions/canvas/src/host/a2ui-app/rolldown.config.ts",
