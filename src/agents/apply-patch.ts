...
import { openRootFile, type RootFileOpenResult } from "../infra/boundary-file-read.ts";
import { root as fsRoot } from "../infra/fs-safe.ts";
import { PATH_ALIAS_POLICIES, type PathAliasPolicy } from "../infra/path-alias-guards.ts";
import { applyUpdateHunk } from "./apply-patch-update.ts";
import { toRelativeSandboxPath, resolvePathFromInput } from "./path-policy.ts";
