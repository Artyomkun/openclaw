...
import type { CompactionEntry, SessionEntry, SessionHeader } from "../sessions/index.ts";
import { collectDuplicateUserMessageEntryIdsForCompaction } from "./compaction-duplicate-user-messages.ts";
import { stripThinkingSignaturesFromMessage } from "./thinking.ts";
import {
