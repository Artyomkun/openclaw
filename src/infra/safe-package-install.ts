...
import type { NpmProjectInstallEnvOptions } from "./npm-install-env.ts";
import { createNpmProjectInstallEnv } from "./npm-install-env.ts";
 ...
 * Callers opt into dependency omission, older peer resolution, and quiet flags.
 */
