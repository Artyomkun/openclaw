...
import { resolveGatewayWindowsTaskName } from "../daemon/constants.ts";
import { renderCmdRestartLogSetup } from "../daemon/restart-logs.ts";
import { resolveTaskScriptPath } from "../daemon/schtasks.ts";
...
import { getWindowsCmdExePath } from "./windows-install-roots.ts";
